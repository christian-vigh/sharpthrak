...
namespace Thrak. WinAPI. Enums
   {
	...
	# region WS_EX Window extended style constants
	/// <summary>
	/// Window extended styles constants.
	/// </summary>
	public enum WS_EX_Constants : ulong
	   {
		/// <summary>
		/// Zero value.
		/// </summary>
		WS_EX_NONE			=  0x00000000L,
		...
		/// if the shell language is Hebrew, Arabic, or another language that supports reading-order alignment; otherwise, the style is ignored.
		...
		/// If a tool window has a system menu, its icon is not displayed on the title bar. However, you can display the system menu by 
