...
namespace Thrak. WinAPI. Enums
   {
	# region MB_ constants
	/// <summary>
	/// MessageBox constants.
	/// </summary>
	public enum MB_Constants : long
	   {
		/// <summary>
		...
		/// <summary>
		/// Mask used to isolate MB_DEFBUTTON1 through 4.
		/// </summary>
		...
		/// <summary>
		/// A stop-sign icon appears in the message box. Same as MB_ICONSTOP and MB_ICONERROR.
		/// </summary>
		...
		/// <summary>
		/// Mask used to isolate icon options.
		/// </summary>
		...
		/// <summary>
		/// An exclamation-point icon appears in the message box. Same as MB_ICONEXCLAMATION.
		/// </summary>
		MB_ICONWARNING              	=  MB_ICONEXCLAMATION,

		/// <summary>
		/// Mask used to isolate misc flags, such as modal state.
		/// </summary>
		MB_MISCMASK                 	=  0x0000C000L,

		/// <summary>
		/// Mask used to isolate modal state flag.
		/// </summary>
		MB_MODEMASK                 	=  0x00003000L,

		/// <summary>
		/// Used internally by Windows. Do not specify this flag.
		/// </summary>
		...
		/// In particular, be aware that this flag can produce interactive content on a locked desktop and should therefore be used for only 
		/// a very limited set of scenarios, such as resource exhaustion.
		/// </para>
		/// </summary>
		...
		/// <summary>
		/// Same as MB_APPLMODAL except that the message box has the WS_EX_TOPMOST style. Use system-modal message boxes to notify the user of serious, 
		...
		/// Use this flag when the calling application or library does not have a window handle available but still needs to prevent input 
		/// to other windows in the calling thread without suspending other threads.
		/// </summary>
		...
		/// <summary>
		/// Mask used to isolate the message box type (yes/no, abort/retry/continue, etc.)
		/// </summary>
		MB_TYPEMASK                 	=  0x0000000FL,

		/// <summary>
		/// Indicates that a user-defined icon is to be displayed. Used with MessageBoxIndirect.
		/// </summary>
