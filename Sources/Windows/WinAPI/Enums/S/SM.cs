...
namespace Thrak. WinAPI. Enums
   {
	# region SM_ system metrics constants
	/// <summary>
	...
	public enum SM_Constants : int
	   {
		...
		/// <summary>
		/// Indicates if caret blinking is enabled.
		/// </summary>
		...
		/// <para>
		/// Each item fits into a rectangle of size SM_CXICONSPACING by SM_CYICONSPACING when arranged. 
		/// </para>
		/// <para>
		/// This value is always greater than or equal to SM_CXICON.
		/// </para>
		/// </summary>
		SM_CXICONSPACING        	=  38,
		...
		/// <summary>
		/// The width of the default menu check-mark bitmap, in pixels. Use instead of GetMenuCheckMarkDimensions().
		/// </summary>
		SM_CXMENUCHECK          	=  71,
		...
		/// <para>
		/// The second click must occur within the rectangle defined by SM_CXDOUBLECLK and SM_CYDOUBLECLK for the system to consider the two clicks a double-click. 
		/// The two clicks must also occur within a specified time. 
		/// </para>
		/// <para>
		...
		/// </para>
		/// <para>
		/// This value is always greater than or equal to SM_CYICON.
		/// </para>
		/// </summary>
		SM_CYICONSPACING        	=  39,
		...
		/// </para>
		/// </summary>
		/// <remarks>Windows Server 2008, Windows Vista, and Windows XP/2000:  This value is not supported.</remarks>
		SM_DIGITIZER            	=  94,
		...
		/// </para>
		/// <para>
		/// If the system has only single-touch digitizers, the return value is 1. If the system has multi-touch digitizers, the return value 
		/// is the number of simultaneous contacts the hardware can provide.
		/// </para>
		/// </summary>
		/// <remarks>Windows Server 2008, Windows Vista, and Windows XP/2000:  This value is not supported.</remarks>
		...
		/// For example, the red, green, and blue pixels can be encoded with different numbers of bits, or those bits can be located in different places in a pixel color value. 
		/// </para>
		/// </summary>
		...
		/// <summary>
		/// Nonzero if the current operating system is the Windows XP Tablet PC edition or if the current operating system is Windows Vista or Windows 7 
