/**************************************************************************************************************
    ...
    NAME
        WinAPI/Functions/C/CharLowerBuff.cs

    DESCRIPTION
        CharLowerBuff() Windows function.
	...
	public static partial class User32
	   {
		...
		/// <para>
		/// For example, if CharLowerBuff("Zenith of API Sets", 10) succeeds, the return value is 10.
		/// </para>
		/// </returns>
		/// <remarks>
		/// Note that CharLowerBuff always maps uppercase I ("I") to lowercase i, even when the current language is Turkish or Azeri. 
		/// If you need a function that is linguistically sensitive in this respect, call LCMapString.
		/// </remarks>
		[DllImport ( "User32.dll", SetLastError = true, CharSet = CharSet. Auto )]
		public static extern uint 	CharLowerBuff ( ref String  lpsz, uint  cchLength ) ;
		# endregion
	    }
    }