/**************************************************************************************************************
    ...
    NAME
        WinAPI/Functions/C/CharNext.cs

    DESCRIPTION
        CharNext() Windows function.
	...
	public static partial class User32
	   {
		...
		/// <summary>
		/// Retrieves a pointer to the next character in a string. 
		...
		public static extern IntPtr 	CharNext ( IntPtr  lpsz ) ;
		# endregion
	    }
    }