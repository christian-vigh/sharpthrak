/**************************************************************************************************************
    ...
    NAME
        WinAPI/Functions/C/CharLower.cs

    DESCRIPTION
        CharLower() Windows function.
	...
	public static partial class User32
	   {
		...
		/// </returns>
		/// <remarks>
		/// Note that CharLower always maps uppercase I to lowercase I ("i"), even when the current language is Turkish or Azeri. 
		...
		public static extern String 	CharLower ( ref String  lpsz  ) ;
		# endregion
		...
		/// </remarks>
		[DllImport ( "User32.dll", SetLastError = false, CharSet = CharSet. Auto )]
		public static extern char 	CharLower ( char  lpsz  ) ;
		# endregion
	    }
    }