/**************************************************************************************************************
    ...
    NAME
        WinAPI/User32/E/EnumProps.cs

    DESCRIPTION
        EnumProps() Windows function.
	...
	public static partial class User32
	   {
		...
		/// EnumProps continues until the last entry is enumerated or the callback function returns FALSE.
		/// </summary>
		...
		public static extern int 	EnumProps ( IntPtr  hWnd, PROPENUMPROC  lpEnumFunc ) ;
		# endregion
	    }
    }