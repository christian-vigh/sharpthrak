/**************************************************************************************************************
    ...
    NAME
        WinAPI/User32/F/ExitWindows.cs
	...
	public static partial class User32
	   {
		...
		/// </para>
		/// </remarks>
		public static bool 	ExitWindows ( uint  dwFlags )
		   { return ( ExitWindowsEx ( dwFlags, ( uint ) SHTDN_Constants. SHTDN_REASON_EXITWINDOWS ) ) ; }
		# endregion

		# region Version with EWX constants
		/// <summary>
		/// Logs off the interactive user, shuts down the system, or shuts down and restarts the system. 
		/// It sends the WM_QUERYENDSESSION message to all applications to determine if they can be terminated.
		/// </summary>
		...
		/// </para>
		/// </remarks>
		public static bool 	ExitWindows ( EWX_Constants  dwFlags )
		   { return ( ExitWindowsEx ( dwFlags, SHTDN_Constants. SHTDN_REASON_EXITWINDOWS ) ) ; }
		# endregion
	    }
    }