/**************************************************************************************************************
    ...
    NAME
        WinAPI/User32/R/RegisterClassEx.cs

    DESCRIPTION
        RegisterClassEx() Windows function.
	...
	public static partial class User32
	   {
		...
		/// </returns>
		/// <remarks>
		/// If you register the window class by using RegisterClassExA, the application tells the system that the windows of the created class expect messages 
		/// with text or character parameters to use the ANSI character set; if you register it by using RegisterClassExW, the application requests that the 
		/// system pass text parameters of messages as Unicode. The IsWindowUnicode function enables applications to query the nature of each window. 
		/// <para>
